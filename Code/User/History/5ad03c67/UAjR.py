...
particle=int(input('Particle number (I\'twas 1e7)\n= '))
geoshowans=(input('show geometry? (y or yes = yes; else = no)\n= '))
geoshow=geoshowans.lower()
print(geoshow)
...
u1fer=openmc.YPlane(190.0+250.0+120.0+185.0-10,boundary_type='transmission')
