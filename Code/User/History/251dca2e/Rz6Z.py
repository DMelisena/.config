...
darrw=["W Gy/week"] #dose array Workload
darrdsad=["dsad"] #dose array length from center to detection point
darrsl=['Shield Length (meter)'] #shield length
darrtvl=['TVL'] #Tenth Value Length
darrwh=["Dose on length uSv/h"] #dose array workload per hour
#sl=shieldLength
def lajudosis(W,dsad,sl,TVL):
    ...
    darrsl.append(sl)
    darrtvl.append(TVL)
    darrwh.append(W*1000000/40/(dsad**2))
