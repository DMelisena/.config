...
darrn=['n']
darrdoseop30=['Dose on 30 cm']
darrdoseop100=['Dose on 100 cm']
darrdoseop200=['Dose on 200 cm']
#sl=shieldLength
def lajudosis(W,dsad,sl,TVL):
    ...
    doseop2000=doseop*((dsad**2)/((dsad+2)**2))
...
darray.append(doseop30)
darray.append(doseop100)
darray.append(doseop200)
