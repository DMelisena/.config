...
neutrontally = sp.tallies[3]
neutrondosevalues = neutrontally.get_values() #pSvcm3/src;dosevolume per source
neutrondosestddev = neutrontally.std_dev 
print("neutron :\n")
print(neutrontally)
neutrondosevalues.shape = neutrondosevalues.shape[0]
neutrondosestddev.shape = neutrondosestddev.shape[0]
...
ndose=neutrondosevalues*k/vcell
ndosestddev=neutrondosestddev*k/vcell
